...
import static com.ibao.agroq.utilities.Utilities.URL_DOWNLOAD_TABLE_ENVASE;

public class DownloaderEnvase {

    String TAG= "Down Envase";
    Context ctx;
 //   ProgressDialog progress;
    public static int status;
    public DownloaderEnvase(Context ctx){
        status=0;
        this.ctx = ctx;
    }
   ...
   //     progress.show();
     ...
     //                   progress.dismiss();
                        try {
                            ...
                            if(main.length()>0){
                                new EnvaseDAO(ctx).clearTableUpload();
                                status=2;
                            }
                            ...
                            String insert = "INSERT INTO " +
                                    ...
                                    "("+
                                    TABLE_ENVASE_COL_ID+","+
                                    TABLE_ENVASE_COL_NAME+","+
                                    TABLE_ENVASE_COL_PESONETO+","+
                                    TABLE_ENVASE_COL_PESOTARA+","+
                                    TABLE_ENVASE_COL_IDPROCESO+" "+
                                    ")"+
                                    "VALUES ";
                            for(int i=0;i<main.length();i++){
                                ...
                                String pesoNeto = /*String.valueOf(id)+"-"+*/data.getString("pesoNeto");
                                String pesoTara = /*String.valueOf(id)+"-"+*/data.getString("pesoTara");
                                String idTipoProceso = /*String.valueOf(id)+"-"+*/data.getString("idTipoProceso");
