...
public class ActivityBasicsDescarte extends AppCompatActivity {
    ...
    private String TAG = ActivityBasicsDescarte.class.getSimpleName();
    ...
    private static DescarteVO PRODUCCION;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basics_descarte);
        ...
        if(recibidos!=null){//si se recibe datos
            PRODUCCION = new DescarteDAO(getBaseContext()).buscarById((long)recibidos.getInt(ActivityProceso.REQUEST_ID));
            Gson gson = new Gson();
...
*/
            ...
            DescarteDAO descarteDAO = new DescarteDAO(getBaseContext());

            boolean res =  descarteDAO.setBasicos
                    (PRODUCCION.getId(),idFundo,idVariedad,idEnvase,nProceso,kilos,unidades,new LoginDataDAO(getBaseContext()).verficarLogueo().getIdPlanta(),IDRECEPCION);
            if(!res){
